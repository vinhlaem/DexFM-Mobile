...
const Recovery = () => {
  ...
  const TEXTWARNING = [
    {
      title:
        "Your Recovery Phrase will provide access to this account. Think of it as a login and password combined into one.",
      icon: "key-outline",
    },
    {
      title:
        "Anyone who has this Recovery Phrase will have full access to any funds contained in this account. Your funds may be lost.",
